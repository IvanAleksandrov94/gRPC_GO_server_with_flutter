...
final $typed_data.Uint8List addRequestDescriptor = $convert.base64Decode('CgpBZGRSZXF1ZXN0EhQKBWltYWdlGAEgASgMUgVpbWFnZQ==');
@$core.Deprecated('Use addResponseDescriptor instead')
const AddResponse$json = const {
  '1': 'AddResponse',
  '2': const [
    const {'1': 'imageResult', '3': 1, '4': 1, '5': 12, '10': 'imageResult'},
  ],
};

/// Descriptor for `AddResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List addResponseDescriptor = $convert.base64Decode('CgtBZGRSZXNwb25zZRIgCgtpbWFnZVJlc3VsdBgBIAEoDFILaW1hZ2VSZXN1bHQ=');
